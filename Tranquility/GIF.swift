...
extension UIImage {
    ...
    class func delayForImageAtIndex(_ index: Int, source: CGImageSource!) -> Double {
        ...
        let gifProperties: CFDictionary = unsafeBitCast(
            CFDictionaryGetValue(cfProperties, Unmanaged.passUnretained(kCGImagePropertyGIFDictionary).toOpaque()),                                 //unsafeAddress(of: kCGImagePropertyGIFDictionary)),
        ...
        if delayObject.doubleValue == 0 {
            delayObject = unsafeBitCast(CFDictionaryGetValue(gifProperties,
                                                             ...
                                                             //unsafeAddress(of: kCGImagePropertyGIFDelayTime)),
                to: AnyObject.self)
        }
